<x-dashboard.layouts.app>
    <div class="container-fluid">
        <div class="card mb-4">
            <x-dashboard.layouts.partials.card-header :createRoute="route('dashboard.coming_soons.create')"/>
            ...
            <div class="card-body">
                ...
                <x-dashboard.datatable._table>
                    ...
                    <th data-key="target_datetime">{{ __('label.target_datetime') }}</th>
    ...
    <x-slot name="scripts">
        <script src="{{ asset('/js/dashboard/coming_soon/index.js') }}"></script>
    </x-slot>
</x-dashboard.layouts.app>
