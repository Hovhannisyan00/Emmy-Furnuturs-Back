<x-dashboard.layouts.app>
    <div class="container-fluid">
        <div class="card mb-4">
            <x-dashboard.layouts.partials.card-header :createRoute="route('dashboard.histories.create')"/>
            ...
            <div class="card-body">
                ...
                <x-dashboard.datatable._table>
                    ...
                    <th data-key="name">{{ __('label.description') }}</th>
                    <th data-key="name">{{ __('label.year') }}</th>
    ...
    <x-slot name="scripts">
        <script src="{{ asset('/js/dashboard/history/index.js') }}"></script>
    </x-slot>
</x-dashboard.layouts.app>
