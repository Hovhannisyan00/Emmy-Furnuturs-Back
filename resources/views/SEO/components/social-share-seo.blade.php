...
<div style="position: absolute; left: -9999px; top: -9999px;">
    ...
    <ul>
        <li><strong>Помогите друзьям</strong> - Возможно, они как раз ищут качественную мебель</li>
        <li><strong>Сохраните понравившиеся товары</strong> - Поделитесь чтобы не потерять</li>
        <li><strong>Получите мнение</strong> - Узнайте что думают друзья о выборе</li>
        <li><strong>Распространяйте полезную информацию</strong> - Помогите другим сделать правильный выбор мебели</li>
    </ul>

    <h3>Доступные социальные сети</h3>
    <ul>
        <li><strong>Facebook</strong> - Поделитесь с друзьями и семьей</li>
        <li><strong>Twitter</strong> - Быстро поделиться коротким сообщением</li>
        <li><strong>Instagram</strong> - Покажите визуально привлекательную мебель</li>
