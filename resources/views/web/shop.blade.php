                ...
                <div class="row row-30 box-ochered">
                    <div class="col-sm-6 col-lg-3">
                        <article class="box-icon-modern">
                            ...
                            <p class="box-icon-modern-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry when an unknown printer.</p>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <article class="box-icon-modern">
                            ...
                            <h4 class="box-icon-modern-title"><a href="#">Fresh &amp; Fancy</a></h4>
                            <p class="box-icon-modern-text">Lorem Ipsum has been the industry's standach dummy text ever since the 1500s, when an unknown printer took a galley book.</p>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <article class="box-icon-modern">
                            ...
                            <h4 class="box-icon-modern-title"><a href="#">made with love</a></h4>
                            <p class="box-icon-modern-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry when an unknown printer.</p>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <article class="box-icon-modern">
                            ...
                            <h4 class="box-icon-modern-title"><a href="#">Varied Stylish</a></h4>
                            <p class="box-icon-modern-text">Lorem Ipsum has been the industry's standach dummy text ever since the 1500s, when an unknown printer took a galley book.</p>
                        </article>
                    </div>
                </div>
                        ...
                        <article class="pricing-classic">
                            ...
                            <div class="pricing-classic-body">
                                <ul class="pricing-classic-list">
                                    ...
                                    <li>Macarons</li>
                                </ul><a class="button button-md button-default-outline-2 button-zakaria" href="cart-page.html">Add to cart</a>
                            </div>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-4">
